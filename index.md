...
> He llegado a **reducir hasta un 2–3% los costes** en proyectos internos, optimizando procesos, recursos y toma de decisiones.
...
- **SQL** (consultas, joins, CTEs, ventanas)
- **Power BI / Tableau** (dashboards interactivos)
- **Python** (Pandas, análisis exploratorio, visualización)
- **Git & GitHub** (versionado, colaboración, portfolio técnico)
...
- **Resultado:** identificación de oportunidades de reducción de stock valoradas en **X% del inventario total**.
